...
export class Vector2 implements Vector {
    ...
    /**
     * If this vector's x or y value is greater than v's x or y value, replace that value with the corresponding min
     * value.
     */
    min(v: Vector2): this;
    ...
    /**
     * If this vector's x or y value is greater than the max vector's x or y value, it is replaced by the corresponding
     * value. If this vector's x or y value is less than the min vector's x or y value, it is replaced by the
     * corresponding value.
    ...
    /**
     * Linearly interpolates between this vector and v, where alpha is the distance along the line - alpha = 0 will be
     * this vector, and alpha = 1 will be v.
    ...
    /**
     * Sets this vector to be the vector linearly interpolated between v1 and v2 where alpha is the distance along the
     * line connecting the two vectors - alpha = 0 will be v1, and alpha = 1 will be v2.
