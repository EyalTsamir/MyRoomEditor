...
export class Object3D extends EventDispatcher {
    ...
    /**
     * When this is set, it checks every frame if the object is in the frustum of the camera before rendering the
     * object. If set to false the object gets rendered every frame even if it is not in the frustum of the camera.
     * @default true
     */
    ...
    /**
     * An object that can be used to store custom data about the Object3d. It should not hold references to functions
    ...
    /**
     * Rotate an object along an axis in world space. The axis is assumed to be normalized. Method Assumes no rotated
     * parent.
     * @param axis    A normalized vector in object space.
     * @param angle    The angle in radians.
     */
