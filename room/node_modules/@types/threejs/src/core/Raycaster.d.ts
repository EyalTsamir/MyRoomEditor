...
export class Raycaster {
    ...
    /**
     * The camera to use when raycasting against view-dependent objects such as billboarded objects like Sprites. This
     * field can be set manually or is set when calling "setFromCamera".
     */
    camera: Camera;
    ...
    /**
     * Updates the ray with a new origin and direction.
     * @param coords 2D coordinates of the mouse, in normalized device coordinates (NDC)---X and Y components should be
     *     between -1 and 1.
