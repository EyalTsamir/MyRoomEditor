...
export class WebGLMultisampleRenderTarget extends WebGLRenderTarget {
    ...
    /**
     * Specifies the number of samples to be used for the renderbuffer storage.However, the maximum supported size for
     * multisampling is platform dependent and defined via gl.MAX_SAMPLES.
     * @default 4
     */
    samples: number;
}
